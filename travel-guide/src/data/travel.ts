...
export const beerGuide = {
  museum: {
    name: "青岛啤酒博物馆",
    aka: "一厂",
    address: "市北区登州路56号",
    hours: "8:30-17:30（16:30停止入场）",
    price: "旺季60元/人，淡季50元/人",
    tips: [
      "门票含一杯原浆+一杯纯生+一包啤酒豆（蜜滴花生）",
      "建议提前在公众号或美团购票，现场排队人多",
      "A馆看历史文物，B馆看生产线，C馆品酒互动",
      "醉酒小屋必体验——不喝酒也能感受醉酒眩晕",
      "伴手礼推荐啤酒豆和原浆啤酒，仅此有售",
    ],
    transport: "公交205/217/221/604路「啤酒博物馆」站，或地铁2号线台东站步行10分钟",
  },
  beerTypes: [
    { name: "原浆", desc: "未过滤、未杀菌，保质期仅7天，口感最醇厚鲜爽", icon: "🍺", tag: "必喝", tagType: "red" as const },
    { name: "纯生", desc: "过滤但未杀菌，口感清爽，比瓶装纯生新鲜得多", icon: "🍻", tag: "推荐", tagType: "orange" as const },
    { name: "黑啤", desc: "焦香浓郁、泡沫绵密，不是所有人都能接受", icon: "🫗", tag: "进阶", tagType: "blue" as const },
    { name: "白啤（奥古特）", desc: "比利时风格小麦白啤，果香明显，适合入门", icon: "🥂", tag: "适口", tagType: "green" as const },
    { name: "瓶装/罐装", desc: "超市常见款，和散装完全是两种体验，应急喝喝", icon: "📦", tag: "日常", tagType: "blue" as const },
  ],
  localTips: [
    { title: "散啤才是灵魂", desc: "青岛人喝的「袋装啤酒」是散装鲜啤，塑料袋一装、提着就走。4-5元/斤，当天的最新鲜，隔夜风味大减。居民区路边啤酒屋都有售。" },
    { title: "认准一厂原浆", desc: "青岛有多个啤酒厂，一厂（登州路本厂）的原浆公认最佳。啤酒博物馆就在一厂内，喝到的是当天下线的。市面标注「一厂原浆」的要看清，有些店挂羊头卖狗肉。" },
    { title: "啤酒屋怎么选", desc: "别去登州路啤酒街——专宰游客。去居民区的街边啤酒屋，门口摆着大啤酒桶的那种，3-5元一杯。台东周边、四方路、市南区老街巷都是本地人去处。" },
    { title: "袋啤喝法", desc: "用吸管直接喝，别倒杯子里——倒出来跑气变味。买的时候让老板给插好吸管，边走边吸，这才是青岛人的打开方式。" },
    { title: "配什么吃", desc: "辣炒蛤蜊+袋装原浆是青岛灵魂组合。烤鱿鱼、鲅鱼水饺、炸肉也是绝配。啤酒配海鲜讲究「一辣三鲜」：辣炒、清蒸、凉拌、生吃。" },
  ],
  beerStops: [
    { name: "青岛啤酒博物馆（一厂）", type: "打卡品酒", price: "门票60元含2杯", highlight: "唯一能喝到现酿原浆的地方", area: "登州路" },
    { name: "台东夜市啤酒摊", type: "夜市畅饮", price: "袋装4-5元/斤", highlight: "最热闹，配夜市小吃", area: "台东" },
    { name: "居民区啤酒屋", type: "本地体验", price: "3-5元/杯", highlight: "3-5元一杯，最正宗的青岛味道", area: "全市各居民区" },
    { name: "四方路老街啤酒屋", type: "老青岛味", price: "5-8元/杯", highlight: "老城区氛围，配辣炒蛤蜊", area: "市南老城区" },
    { name: "营口路海鲜+啤酒", type: "自买加工", price: "啤酒5元+加工费", highlight: "买海鲜找店加工，人均80吃海鲜大餐", area: "营口路" },
  ],
};
